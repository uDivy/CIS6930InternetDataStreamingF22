...
d = int(input("Number of segments(d):\n"))

print("The value of n, m and d are:",n, m, d)
...
randomnums = np.random.randint(1, m + 1, d)
hash_table = [(0, 0)] * n
flows = gen_flows(m)
...
"""
This will insert the new flowid prioritising the left most slot while insertion.
"""
def insert(flowid):
    for i in range(d):
        h = multiplication_hash(n, flowid ^ randomnums[i])
